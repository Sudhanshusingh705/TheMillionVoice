...
add_action( 'tgmpa_register', 'minimalist_newspaper_register_required_plugins' );
 ...
 */
function minimalist_newspaper_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'minimalist-newspaper',                 // Unique ID for hashing notices for multiple instances of TGMPA.
