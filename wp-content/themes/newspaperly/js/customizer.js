 ...
 */
 ...
 ( function( $ ) {
	...
	wp.customize( 'sidebar_border_color', function( value ) {
		value.bind( function( to ) {
			$( '#secondary .swidgets-wrap, .featured-sidebar .search-field' ).css( {
				'border-color':to
			});
		} );
	} );
	...
	wp.customize( 'content_bg_colors', function( value ) {
		value.bind( function( to ) {
			$( '.header-widgets-wrapper, .content-wrap-bg' ).css( {
				'background-color':to
			});
		} );
	} );
	wp.customize( 'sidebar_general_border_color', function( value ) {
		value.bind( function( to ) {
			$( '.featured-sidebar, .featured-sidebar ul li' ).css( {
				'border-color':to
			});
		} );
	} );
	wp.customize( 'blogfeed_buttonbg_color', function( value ) {
		value.bind( function( to ) {
			$( '.page-numbers li a, .blogposts-list .blogpost-button, .page-numbers.current, span.page-numbers.dots' ).css( {
				'background':to
			});
		} );
	} );
	wp.customize( 'header_banner_bordercolor', function( value ) {
		value.bind( function( to ) {
			$( '.banner-widget-wrapper ul li' ).css( {
				'border-color':to
			});
		} );
	} );

	wp.customize( 'header_banner_linkcolor', function( value ) {
		value.bind( function( to ) {
			$( '.banner-widget-wrapper a, .banner-widget-wrapper a:hover, .banner-widget-wrapper a:active, .banner-widget-wrapper a:focus' ).css( {
				'color':to
			});
		} );
	} );
	...
	wp.customize( 'header_banner_textcolor', function( value ) {
		value.bind( function( to ) {
			$( '.banner-widget-wrapper p, .banner-widget-wrapper h1, .banner-widget-wrapper h2, .banner-widget-wrapper h3, .banner-widget-wrapper h4, .banner-widget-wrapper h5, .banner-widget-wrapper h6, .banner-widget-wrapper ul, .banner-widget-wrapper' ).css( {
				'color':to
			});
		} );
	} );
