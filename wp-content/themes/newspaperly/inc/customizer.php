 ...
 */
function newspaperly_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'newspaperly' );
	$wp_customize->get_section('colors')->title = __( 'Other Colors', 'newspaperly' );

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'newspaperly_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'newspaperly_customize_partial_blogdescription',
			) );
	}
	...
	$wp_customize->add_setting( 'header_banner_textcolor', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_banner_textcolor', array(
		'label'       => __( 'Header Widget Text Color', 'newspaperly' ),
		'section'     => 'header_image',
		'priority'   => 1,
		'settings'    => 'header_banner_textcolor',
		) ) );

	$wp_customize->add_setting( 'header_banner_linkcolor', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_banner_linkcolor', array(
		'label'       => __( 'Header Widget Link Color', 'newspaperly' ),
		'section'     => 'header_image',
		'priority'   => 1,
		'settings'    => 'header_banner_linkcolor',
		) ) );

	$wp_customize->add_setting( 'header_banner_bordercolor', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_banner_bordercolor', array(
		'label'       => __( 'Header Widget Border Color', 'newspaperly' ),
		'section'     => 'header_image',
		'priority'   => 1,
		'settings'    => 'header_banner_bordercolor',
		) ) );
	...
	$wp_customize->add_section( 'sidebar_settings', array(
		'title'      => __('Sidebar Settings','newspaperly'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_border_color', array(
		'label'       => __( 'Headline Border Color', 'newspaperly' ),
		'section'     => 'sidebar_settings',
		'priority'   => 1,
		'settings'    => 'sidebar_border_color',
		) ) );
	$wp_customize->add_setting( 'sidebar_general_border_color', array(
		'default'           => '#ececec',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_general_border_color', array(
		'label'       => __( 'General Border Color', 'newspaperly' ),
		'section'     => 'sidebar_settings',
		'priority'   => 1,
		'settings'    => 'sidebar_general_border_color',
		) ) );

}
add_action( 'customize_register', 'newspaperly_customize_register' );
 ...
 * @return void
 */
function newspaperly_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function newspaperly_customize_partial_blogdescription() {
 ...
 */
function newspaperly_customize_preview_js() {
	wp_enqueue_script( 'newspaperly-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'newspaperly_customize_preview_js' );
